...
"use strict"; // function Cals():number // number defines the datatype
// {
...
// tsc -- init is used to make the command of json file in root directory we
// show src and ouput directory public
//simple program to understand ts 
// const num:number = 10;
// console.warn(num)
// let num:number=10;
